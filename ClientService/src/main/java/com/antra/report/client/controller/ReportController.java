...
public class ReportController {
    ...
    public void downloadFile(@PathVariable String reqId, @PathVariable FileType type, HttpServletResponse response) throws IOException {
        ...
        //System.out.println("ReportController: this position is in downloadFile Function");
   ...
   @DeleteMapping("/report/content/delete/{reqId}")
    public void deleteFile(@PathVariable String reqId){
       reportService.deleteFileByReqId(reqId);
   }
